...
import adminInstance from '../../../axios_interceptors/admin_axios.jsx'
...
const AddCategory = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await adminInstance.post(`/admin/categories`, {
  ...
  const handleDelete = async (categoryId) => {
    if (window.confirm('Are you sure you want to delete this category?')) {
      try {
        const response = await adminInstance.delete(`/admin/categories/${categoryId}`);
